...
def main():
    ...
    # Test 5: Fetch archived items
    print("Test 5: Fetch archived items")
    try:
        response = requests.get(url, headers=headers, params={"page": 0, "size": 100, "supplierId": seller_id, "archived": "true"}, timeout=30)
